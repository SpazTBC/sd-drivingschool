...
if GetResourceState('qb-core') == 'started' then
    Framework.GetFramework = function()
        return exports['qb-core']:GetCoreObject()
    end
    Framework.ShowNotification = function(message, type)
        QBCore.Functions.Notify(message, type or 'primary')
    end
    Framework.ShowMenu = function(menuData)
...
function HasLicense(licenseType, cb)
    if Config.Framework == 'qbcore' then
        ...
        -- For ESX, you'd need to implement license checking
        cb(false)
    end
end
...
RegisterNetEvent('sd-drivingschool:client:openSubMenu', function(data)
    ...
    Framework.ShowMenu(subMenuItems)
end)
...
RegisterNetEvent('sd-drivingschool:client:buyReplacement', function(data)
    ...
    Framework.ShowMenu(confirmMenu)
end)
...
function StartDrivingTest()
    ...
    -- Spawn vehicle
    QBCore.Functions.SpawnVehicle(licenseData.vehicle, function(veh)
        testVehicle = veh
        ...
        Framework.ShowNotification('Driving test started! Follow the checkpoints and drive safely.', 'success')
